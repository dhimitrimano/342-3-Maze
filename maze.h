...
private:
  ...
  // true if row, column is the start
  bool atStart(int row, int column) const;

  // helper function for solve()
  bool pathFinder(int dir, int x, int y);

  //turns the path int into a string letter
  string pathString(int dir);
};
